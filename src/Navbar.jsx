...
const Navbar = () => {
  ...
  <div className="container-fluid">
    <NavLink  className="navbar-brand" to="/">My cryptocurrency trading bot</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink activeClassName="menu_active" className="nav-link" to="/contact">Contact Page</NavLink>
        </li>
