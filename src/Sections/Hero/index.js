    ...
    <HomeSection id="home">
      ...
      <MainContent id="home">
        <Lb id="leftBlock">
          <Topic>
            <Circle />
            <span>We sell crypto trading bots</span>
          </Topic>
          <Title>CRYPTO-CURRENCY TRADING APP</Title>
          <SubText>
          Transforming your cryptocurrency trading using the comprehensive trading app
          </SubText>
          <CTA>
